...
const sourceFile = new URL('../data/provided.json', import.meta.url);
...
console.log('PASS domain: exact money, split rounding, code ranges, 11 columns, depreciation floor' + (source ? ', 4,312 private source rows and set headings' : '; private source fixture not included in this checkout'));
